#Test Famous
> Test project to just explore.

[![Build Status](https://travis-ci.org/navneetabh/test-famous.svg?branch=master)](https://travis-ci.org/navneetabh/test-famous) [![Dependency Status](https://david-dm.org/navneetabh/test-famous.svg)](https://david-dm.org/navneetabh/test-famous) [![devDependency Status](https://david-dm.org/navneetabh/test-famous.svg)](https://david-dm.org/navneetabh/test-famous#info=devDependencies)
...
## Release History
 * 2014-05-05   v0.1.0   Generated by the [Yeoman Generator](https://github.com/famous/generator-famous) for [Famo.us](http://famo.us)